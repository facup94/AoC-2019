...
func day17BHelp() {
	...
	for {
		output, PC = runProgramDay17Help(memory, PC, inputList[inputIndex])
		if output == -3 {
			inputIndex++
			continue
		}
...
func runProgramDay17Help(memory []int, instructionPointer, input int) (int, int) {
